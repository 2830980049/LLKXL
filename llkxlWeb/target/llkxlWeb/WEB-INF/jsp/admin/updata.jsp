...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- 主要内容 -->
        <form id="fm-register" action="updatanew.do" class="content" method="post">
            <!--年度计划界面-->
                    ...
                    <form form-control>
                        <table class="table  table-condensed table-responsive">
                            <tr>
                                ...
                                <td>登录名</td>
                                <td>
                                    <input type="text" class="form-control" name="loginName" id="loginName" value="${loginName}" readonly>
                                    <span class="msg-default hidden">用户名长度在1到10位之间</span>
                                </td>
                                <td>QQ</td>
                                <td>
